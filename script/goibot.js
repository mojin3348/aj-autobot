...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var master = tl[Math.floor(Math.random() * tl.length)]
    ...
    var tl = ["haahahaha", "whahaha", "nakakarindi tawa mo tangina ka", "tawa tawa geng geng", "happy?", "la naman nakakatawa", "BOBO", "PUTANGINA NETO OH", "hahahaha abnormal", "hahaha asuming", "Ang saya mo naman pakiss nga", "masaya kana ba sakin?"];
  var happy = tl[Math.floor(Math.random() * tl.length)]
    ...
    if (event.body.indexOf("bot")==0 ||(event.body.indexOf("Bots")==0 ||(event.body.indexOf("pareto ako bot")==0 ||(event.body.indexOf("Automatic")==0 ||(event.body.indexOf("AJ CHICANO")==0 ||(event.body.indexOf("Robot")==0 ||(event.body.indexOf("Bot")==0 ||(event.body.indexOf("Robot")==0 ||(event.body.indexOf("ganda ng bot")==0 ||(event.body.indexOf("pangit ng bot")==0 ||(event.body.indexOf("别")==0 ||(event.body.indexOf("Boto")==0 || (event.body.indexOf("Botot")==0 || (event.body.indexOf("BOT")==0 || (event.body.indexOf("ang sama ng bot")==0))))))))))))))) {
      var msg = {
        body: `${master}`
      }
      api.sendMessage(msg, threadID, messageID);
